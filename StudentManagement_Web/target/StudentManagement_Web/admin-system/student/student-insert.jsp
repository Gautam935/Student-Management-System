...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#form1").submit(function(e) {
			...
			var acedemicYear = document.getElementById("acedemicYear").value;
			...
			var data1=JSON.stringify(save);
			alert(data1);
			
			var url = "http://localhost:8089/student/addStudents?stuId="+ stuId +"&stuName="+ stuName +"&stuAddress="+stuAddress+"&telNo="+telNo+"&email="+email+"&acedemicYear="+acedemicYear;
	...
	<div class="wrapper">
		<div class="sidebar" data-color="purple"
			...
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="" class="simple-text"> Admin'S SITE </a>
				</div>
				...
				<ul class="nav">
					...
					<li class="active"><a href="../student.jsp"> <i
							class="pe-7s-user"></i>
							<p>Student</p>
					</a></li>
					...
					<li><a href="../examRegistration.jsp"> <i
							class="pe-7s-bell"></i>
							<p>Approval</p>
					</a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li><a href="../student.jsp">View</a></li>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Student Name</label> <input type="text"
														...
														id="stuName" name="subject" required>
												</div>
											</div>
										</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Student Address</label> <input type="text"
														...
														id="stuAddress" name="subject" required>
												</div>
											</div>
										</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Tel No</label> <input type="text"
														class="form-control" placeholder="Tellephone Number "
														id="telNo" name="telNo" required>
												</div>
											</div>
										</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Acedemic Year</label> <input type="text"
														class="form-control" placeholder="Acedemic Year"
														id="acedemicYear" name="acedemicYear" required>
												</div>
											</div>
										</div> <!-- <div class="row" style="padding: 10 10 10 10">
											<div class="col-md-12">
												<div class="form-group">
													<label>message</label>
