...
<script>
	...
	app.controller('subjectController', function($scope, $http) {
		$http.get('http://localhost:8089/subjects/getAllSubjects').then(
				function(response) {
		...
		$scope.deletefun = function(id) {
			...
			$http({
			    method: 'DELETE',
			    url: 'http://localhost:8089/subjects/deleteSubject?subjectId='+id,
			    data: {
			    	subjectId: id
			    },
			    headers: {
...
/*  app.controller('deleteController', function($scope, $http) {
	 $scope.deleteSubject= function(){	
		 ...
		 $http({
			  method: 'GET',
			  url: "http://localhost:8083/api/subject-delete?subjectId="+val,
	...
	/* $(document).ready(function() {
		$("#delete").click(function(e) {
			...
			var url = "http://localhost:8083/api/subject-delete?subjectId="+val;
