...
$(document).ready(function() {
	$("#form1").submit(function(e) {
		...
		var url = "http://localhost:8089/student/updateStudents?stuId="+ stuId +"&stuName="+ stuName +"&stuAddress="+stuAddress+"&telNo="+telNo+"&email="+email+"&acedemicYear="+acedemicYear;
